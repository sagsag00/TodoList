...
public class Home_Fragment extends Fragment {
    ...
    private View homeFragmentView; // The current view.
    private Set<Integer> usedRequestCodes = new HashSet<>(); // Saves the used request codes.
    private List<Integer> newProjectIds = new ArrayList<>(); // The ids of all of the projects created.
    ...
    private void init(){
        ...
        newProjectButton = (Button) homeFragmentView.findViewById(R.id.newProjectButton);
        newProjectButton2 = (Button) homeFragmentView.findViewById(R.id.newProjectButton2);
        mainLayout = (RelativeLayout) homeFragmentView.findViewById(R.id.MainLayout);
        constLayoutContainer = (ConstraintLayout) homeFragmentView.findViewById(R.id.homeFragmentConstLayout);
    ...
    public void onClickNewProjectButton(View view) {
        // On click listener for the newProjectButton (the plus).
    ...
    public void createProjects(){
        ...
        createProjectView(lastProject, projects.size() - 1);

        projectId = (int) lastProject.getProjectId();
        createNotifications(lastProject);
    }

    public void createNotifications(Project project){
    ...
    public void createNotification(String time, List<Integer> days, String interval, RemindersStartXBefore startXBefore, String date){
    ...
    public void setNotification(long timeInMillis, String interval) {
    ...
    public void createProjectView(Project project, int index){
        ...
        newProjectIds.add(projectButton.getId());
    ...
    public TextView createTaskComment(String comment){
    ...
    public boolean isRequestCodeTaken(int requestCode){
